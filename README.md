...
المنصة عربية أولًا: تشرح كل معيار، وتُخفي تنبؤات المحلِّل حتى لا تتأثر أحكام المحكِّم، وتحفظ هوية المشارك مشفَّرة خارج GitHub، ولا تُدخل إلى المستودع إلا أدلة لغوية موقَّعة ومُعمّاة الهوية عبر طلب مراجعة (pull request). وتصل الحزم العمياء إلى قائمة مهام الحساب من دليل مستودع محمي ومتحقق منه؛ فلا يحتاج المحكّم إلى تبادل ملفات JSON، وتنتقل أدلة A وB إلى J1 ثم حزمة J1 إلى J2 تلقائيًا. وتتوفر حسابات Passkey، ومراجعات مشفّرة للمسودات، ونسخة استرداد محلية، والأسماء الاجتماعية الخاصة الاختيارية، والإرسال المركزي. ويبقى كل أثر مُرسَل داخلًا إلى المستودع عبر تحقق آلي وطلب مراجعة.

وتظهر عيّنة PILOT التشغيلية أول قائمة المهام بوصفها العيّنة الأساسية التي
يتعرّف بها المحكّم إلى الحفظ والإرسال، مع بقائها معزولةً تمامًا عن أدوار
الإجماع العلمي. كما تتضمن الواجهة قناة بلاغ مباشرة: يُرسل الحساب وصفًا تقنيًا
منقّى إلى مخزن المنصّة، ثم تنشئ GitHub Actions مسألةً عامةً في المستودع دون
إرسال اسم المحكّم أو بريده أو مسودته أو قراراته اللغوية.
