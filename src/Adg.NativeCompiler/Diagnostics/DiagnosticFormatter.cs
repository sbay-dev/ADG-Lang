...
internal static class DiagnosticFormatter
{
    ...
    public static string Id(DiagnosticCode code) => code switch
    {
        ...
        DiagnosticCode.SkeletonConservationViolation => "ADG-F010",
        DiagnosticCode.DuplicateLexiconEntry => "ADG-F011",
        DiagnosticCode.EmptyRefiner => "ADG-F012",
        DiagnosticCode.UndefinedRefinerApplication => "ADG-F013",
        DiagnosticCode.InvalidNormalizationRule => "ADG-F014",
        DiagnosticCode.EmptyRefinerProgram => "ADG-F015",
        DiagnosticCode.MultipleRefinerApplications => "ADG-F016",
        _ => "ADG0000"
    };
    ...
    public static string Name(DiagnosticCode code) => code switch
    {
        ...
        DiagnosticCode.SkeletonConservationViolation => nameof(DiagnosticCode.SkeletonConservationViolation),
        DiagnosticCode.DuplicateLexiconEntry => nameof(DiagnosticCode.DuplicateLexiconEntry),
        DiagnosticCode.EmptyRefiner => nameof(DiagnosticCode.EmptyRefiner),
        DiagnosticCode.UndefinedRefinerApplication => nameof(DiagnosticCode.UndefinedRefinerApplication),
        DiagnosticCode.InvalidNormalizationRule => nameof(DiagnosticCode.InvalidNormalizationRule),
        DiagnosticCode.EmptyRefinerProgram => nameof(DiagnosticCode.EmptyRefinerProgram),
        DiagnosticCode.MultipleRefinerApplications => nameof(DiagnosticCode.MultipleRefinerApplications),
