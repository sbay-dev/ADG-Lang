        ...
        List<SemanticFrame> semanticFrames)
    {
        switch (node)
        {
            ...
            case OperatorApplication application:
                ...
                break;
            case HiddenReference reference:
                relations.Add(new ResolvedRelation("HiddenReference", reference.Surface, TypeContracts.Describe(reference.Target)));
                semanticFrames.Add(new SemanticFrame("HiddenReference", reference.Surface, [reference.Certainty]));
                Visit(reference.Target, relations, operators, semanticFrames);
                break;
            case Clause clause:
